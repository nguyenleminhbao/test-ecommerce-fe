<template>
  ...
  >
    ...
    >
      ...
      <h1 class="text-headline-3 max-sm:text-headline-4">Product Page</h1>
      <span class="text-body-1 max-sm:text-body-2"
        >Let’s design the place you always imagined.</span
      >
    </div>
  </div>
</template>
